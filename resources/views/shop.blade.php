...
@section('content')
  <style>
      ...
      .brand-list li .category-list li .chk-category{
          width:1rem;
          height:1rem;
          color: #e4e4e4;
...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
                ...
                <div class="accordion-item mb-4 pb-3">
                  ...
                  <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                    ...
                    <div class="search-field multi-select accordion-body px-0 pb-0">
                      <div class="search-fields multi-select accordion-body px-0 pb-0">
                ...
                <div class="accordion-item mb-4">
                  ...
                  <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                    ...
                    <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="10000"
                      data-slider-max="10000000" data-slider-step="10000" data-slider-value="[{{ $min_price }},{{ $max_price }}]" data-currency="Rp" />
                    <div class="price-range__info d-flex align-items-center mt-2">
                      ...
                      <div>
                        ...
                        <span class="price-range__max">Rp10.000.000</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-9 col-md-8 shop-list">
                      ...
                      <div class="slide-split_text position-relative d-flex align-items-center"
                        ...
                        <div class="slideshow-text container p-3 p-xl-5">
                          <h2
                            ...
                            Elevate <br /><strong>Your Daily Style</strong></h2>
                          <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Temukan koleksi terbaru kami yang dirancang khusus untuk mendukung produktivitas dan kepercayaan diri Anda. </p>
                        </div>
                      </div>
                    ...
                    <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                      <div class="slide-split_text position-relative d-flex align-items-center"
                        ...
                        <div class="slideshow-text container p-3 p-xl-5">
                          <h2
                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                            <strong>Crafted with Excellence</strong></h2>
                    ...
                    <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                      <div class="slide-split_text position-relative d-flex align-items-center"
                        ...
                        <div class="slideshow-text container p-3 p-xl-5">
                          <h2
                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                            Exclusive Offers<br /><strong>Just For You</strong></h2>
                          <p class="mb-0 animate animate_fade animate_btt animate_delay-5"></p>
                        </div>
                      </div>
                      <div class="slide-split_media position-relative">
